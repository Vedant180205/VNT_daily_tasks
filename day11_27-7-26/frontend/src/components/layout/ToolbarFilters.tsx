  ...
  return (
    <div className="flex flex-wrap items-center gap-4 w-full justify-between">
      <div className="flex flex-wrap items-center gap-4">
        ...
        {onStatusChange && (
          <div className="flex items-center gap-2 text-[14px] text-muted font-medium bg-gray-50/50 rounded-lg pr-2">
            <svg className="ml-3 text-muted w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
            <Select value={status || ''} onChange={(e) => onStatusChange(e.target.value)} className="w-[120px] border-none shadow-none focus-visible:ring-0 text-[14px] h-[40px] bg-transparent font-semibold text-text">
