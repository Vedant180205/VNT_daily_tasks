            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50/50">
                  <th className="px-6 py-3 text-xs font-bold text-muted uppercase">Organizer Name</th>
                  <th className="px-6 py-3 text-xs font-bold text-muted uppercase">Organization</th>
                  <th className="px-6 py-3 text-xs font-bold text-muted uppercase">Contact</th>
