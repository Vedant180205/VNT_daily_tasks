  ...
  return (
    <PageContainer>
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
        <h1 className="text-[48px] font-[800] text-[#111827] tracking-tight leading-none mb-2">Organizers Lifecycle Management</h1>
        <p className="text-muted text-base">3-Section Admin Approval Workflow: Lead Applications → KYC Verification → Active Organizers.</p>
      </motion.div>
